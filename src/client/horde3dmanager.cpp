...
QList<Entity*> Horde3DManager::skyboxes() const
{
	return _skyboxes;
} // end contentDirs
...
void Horde3DManager::setSkyboxes(QList<Entity*> skyboxes)
{
	_skyboxes = skyboxes;
...
void Horde3DManager::addSkybox(Entity* skybox)
{
	_skyboxes.append(skybox);
} // end addSkybox
